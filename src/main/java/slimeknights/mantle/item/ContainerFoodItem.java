...
public class ContainerFoodItem extends Item {
  ...
  public static class FluidContainerFoodItem extends ContainerFoodItem {
    ...
    /** Capability provider for {@link net.neoforged.neoforge.capabilities.Capabilities.FluidHandler#ITEM}; wire via RegisterCapabilitiesEvent.registerItem in the owning mod */
