...
public record HasLootContextSetCondition(LootContextParamSet set) implements LootItemCondition {
  ...
  public static final MapCodec<HasLootContextSetCondition> CODEC = LootContextParamSets.CODEC.xmap(HasLootContextSetCondition::new, HasLootContextSetCondition::set).fieldOf("set");
