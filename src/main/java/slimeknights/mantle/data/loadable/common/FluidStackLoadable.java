...
public class FluidStackLoadable {
  ...
  private static final Predicate<FluidStack> COMPACT_NBT = stack -> !stack.has(DataComponents.CUSTOM_DATA);
  ...
  private static final LoadableField<CompoundTag,FluidStack> NBT = NBTLoadable.ALLOW_STRING.nullableField("nbt", stack -> stack.has(DataComponents.CUSTOM_DATA) ? stack.get(DataComponents.CUSTOM_DATA).copyTag() : null);
